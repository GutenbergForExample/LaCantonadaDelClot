...
<?php
	...
	/* OUR PRODUCT LIST SECTION */

	$zerif_productlist_show = get_theme_mod( 'zerif_productlist_show' );

if ( ( isset( $zerif_productlist_show ) && $zerif_productlist_show != 1 ) || is_customize_preview() ) {

	get_template_part( 'sections/product_list' );
